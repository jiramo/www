...
export default function Privacy() {
  return (
    <div className="p-4 md:pd-6">
      <div className={`${style.wrapper} max-w-7xl mx-auto text-neutral-900 dark:text-white`}>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Privacy Policy) refers to Jiramo.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Jiramo, accessible from{" "}
              <a
                href="https://jiramo.netlify.app/"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://jiramo.netlify.app/
              </a>
              .
            </p>
          </li>
        ...
        <ul>
          <li>By email: info@jiramo.org</li>
        </ul>
      </div>
    </div>
  );
