...
<div className="fixed bottom-6 left-1/2 z-50 -translate-x-1/2 flex items-end gap-3 isolate font-sans antialiased">
  ...
  >
    <div className="relative z-20 flex items-center h-14 w-full shrink-0 pr-2">
      ...
      >
        <div className="relative h-10 w-10 flex items-center justify-center rounded-full bg-black/5 dark:bg-white/5 hover:bg-black/10 dark:hover:bg-white/10 border border-black/5 dark:border-white/5 transition-all">
    ...
    >
      <div ref={contentRef} className="pt-4 pb-2">
        ...
        <div className="mt-2 w-full px-2">
          <div className="h-px w-full bg-linear-to-r from-transparent via-black/10 dark:via-white/10 to-transparent"></div>
        </div>
      </div>
    </div>
  </nav>
